...
async function open_svg_file() { try { svg_document = await file_io.open_svg(); draw_svg(svg_document.text); svg_file_button.textContent = "Save"; svg_file_button.onclick = save_svg_file; keyframe_button.disabled = false; } catch (error) { svg_document = null; keyframe_button.disabled = true; } }
